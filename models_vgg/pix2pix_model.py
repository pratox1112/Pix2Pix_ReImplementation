...
class Pix2PixModel(BaseModel):
    ...
    def backward_G(self):
        ...
        # Second, pixel-wise L1 loss: G(A) ≈ B
        self.loss_G_L1 = self.criterionL1(self.fake_B, self.real_B) * self.opt.lambda_L1

        # Third, perceptual loss using VGG19 features
        # Convert from [-1, 1] → [0, 1] for VGG
        ...
        self.loss_G_perceptual = self.perceptual_loss(feat_fake, feat_real) * self.lambda_perceptual
